...
def startGame():
    ...
    def timeFunc():
        ...
        else: #If count is equal to 10 then show the results, initialize the varaibles and destroy the other widgets
    ...
    wn.bind('<Return>',mainGame)#Runs the mainGame function everytime the user presses enter button
